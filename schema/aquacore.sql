...
CREATE TABLE IF NOT EXISTS `#tasks` (
  ...
  _expression VARCHAR(255) NOT NULL,
  ...
  _error_message VARCHAR(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#users` (
  ...
  _profile_url VARCHAR(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#content` (
  ...
  _plain_content MEDIUMTEXT NOT NULL,
  _protected ENUM('y', 'n') NOT NULL DEFAULT 'n',
