...
<form method="POST">
	...
	<table class="ac-table" id="ac-sort-characters">
		...
		<?php if(empty($characters)) : ?>
			<tr>
				<td colspan="9" style="text-align: center; font-style: italic;"><?php echo __('ragnarok', '0-characters-registered')?></td>
			</tr>
...
<script>
	$("#ac-sort-characters tbody").sortable({
...
<span class="ac-search-result"><?php echo __('ragnarok', 'x-characters-registered', number_format(count($characters)))?></span>
