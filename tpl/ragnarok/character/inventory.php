 ...
 */
assert('isset($inventory_size) && isset($inventory) && isset($paginator) && isset($page)');
...
<span class="ac-search-result"><?php echo __('ragnarok', 'x-items', number_format($inventory_size))?></span>
